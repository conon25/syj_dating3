...
* 상대가 앱이 백그라운드 상태이거나 사용 중이 아닐 경우 FCM만 전송되고 채팅 내역은 DB에 저장됩니다.
* 채팅내역을 secure_storage에 저장하고 이후 새로운 채팅 내역을 DB에서 불러올때 secure_storage 저장되지 않은 채팅내역만 불러오게하여 응답속도를 높였습니다.
<br/>
